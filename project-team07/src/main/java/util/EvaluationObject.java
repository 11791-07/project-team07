...
public class EvaluationObject {
	...
	public EvaluationObject(ArrayList<Double> AP, double MAP, double GMAP,
			ArrayList<Double> precision, ArrayList<Double> recall,
			ArrayList<Double> F, ArrayList<Integer> TP, ArrayList<Integer> FP,
	...
	public void runEvaluation(List<? extends Object> predictions,
			List<? extends Object> gold) {
		int TP = 0, FP = 0, FN = 0;
	...
	public double precision(List<? extends Object> predictions,
			List<? extends Object> gold) {
		int TP = 0, FP = 0;
		for (Object p : predictions) {
			for (Object g : gold) {
	...
	public void AP(List<? extends Object> predictions,
			List<? extends Object> gold) {
		double total = 0.0;
		int rel_total = 0;
